...
def run_raga_recognition_V2_gridSearch():
    ...
    #parameters
    out_dir = '/home/sankalp/Work/Work_PhD/experiments/MotifDiscovery/RagaRecognition/ISMIR_2016/results/PhraseBased/carnatic/gridSearch'
    ...
    scratch_dir = '/home/sankalp/Work/Work_PhD/experiments/MotifDiscovery/RagaRecognition/ISMIR_2016/scratch_network_gen/scratch_folder_carnatic'
    thresholdBin = range(7,11)
...
def run_raga_recognition_V2_gridSearch_5_6():
    
    #parameters
    out_dir = '/home/sankalp/Work/Work_PhD/experiments/MotifDiscovery/RagaRecognition/ISMIR_2016/results/PhraseBased/carnatic/gridSearch_5_6'
    fileListFile = '/media/Data/Datasets/PatternProcessing_DB/unsupervisedDBs/carnaticDB/Carnatic40RagaICASSP2016/__dbInfo__/Carnatic40RagasICASSP2016.flist_local'
    scratch_dir = '/home/sankalp/Work/Work_PhD/experiments/MotifDiscovery/RagaRecognition/ISMIR_2016/scratch_network_gen/scratch_folder_carnatic'
    thresholdBin = range(5,7)
    pattDistExt = ['.pattDistance_2s_config0', '.pattDistance_2s_config2']
    network_wght_type = -1
    force_build_network=0
    feature_type = ['tf-idf']
    pre_processing = [2]
